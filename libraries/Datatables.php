...
//print_r($mColArray);
  ...
  // echo $sWhere; exit();
    ...
    */
	...
	if($tableName=="INVT_T_STOCK_ADJ_HEAD"){
	...
	if($tableName=="INVT_T_REQ_HEAD"){
	    ...
	    $CI = & get_instance();
	    $CI->load->model('InvtMod');
	    $result = $CI->InvtMod->commonGetLocationDescription($aaData[$row_key]['RQH_SRC_LOCN_CODE']);
	    $aaData[$row_key]['RQH_SRC_LOCN_CODE'] = $result[0]['LOCN_DESC'];
	} 
	//material issue
	if($tableName=="INVT_T_MI_HEAD"){
	    $ApproveButton = $_POST['ApproveButton'];	 
...
if($tableName=='SALE_T_OPPORT_HEAD' || $tableName=='SALE_T_LEAD_HEAD' ||  $tableName=='SALE_T_QUOTE_HEAD' || $tableName=='SALE_T_ORDER_HEAD' || $tableName=='SALE_T_DN_HEAD' || $tableName=='SALE_T_INV_HEAD' )
{
  $ApproveButton = $_POST['ApproveButton'];
switch ($tableName) {
    case "SALE_T_OPPORT_HEAD":
        $checkVar='OPH_STATUS';
	$checkVar1='OPH_SYS_ID';	 
        break;
    case "SALE_T_LEAD_HEAD":
        $checkVar='LH_STATUS';
	$checkVar1='LH_SYS_ID';
	break;
    case "SALE_T_QUOTE_HEAD":
	  $checkVar='QH_STATUS';
	  $checkVar1='QH_SYS_ID';
	  break;
    case "SALE_T_ORDER_HEAD":
	  $checkVar='OH_STATUS';
	  $checkVar1='OH_SYS_ID';
	  break;
    case "SALE_T_DN_HEAD":
  ...
  if($aaData[$row_key][$checkVar]=="Incomplete"){
		...
		if ($ApproveButton == 'N') {
		    $aaData[$row_key][$checkVar]='<button data-target="#large_view" id="created" class="btn-new btn-primary statusWidth" data-toggle="modal" disabled>Incomplete</button>';
		}else{
		    $aaData[$row_key][$checkVar]='<button data-target="#large_view" id="created" class="btn-new btn-primary statusWidth" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkVar1].'" onclick=javascript:enquiry_status('.$aaData[$row_key][$checkVar1].')>Incomplete</button>';
		}
	    
	    }else if($aaData[$row_key][$checkVar]=="Send for approval"){
		
		if ($ApproveButton == 'N') {
		    $aaData[$row_key][$checkVar]='<button data-target="#large_view" id="approve" class="btn-new btn-warning statusWidth" data-toggle="modal" disabled>Approve ?</button>';
		}else{
		    $aaData[$row_key][$checkVar]='<button data-target="#large_view" id="approve" class="btn-new btn-warning statusWidth" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkVar1].'" onclick=javascript:enquiry_status('.$aaData[$row_key][$checkVar1].')>Approve ?</button>';
		}
		...
		if ($ApproveButton == 'N') {
		//echo"anand"; exit();
		   $aaData[$row_key][$checkVar]='<button data-target="#large_view" id="approved" class="btn-new btn-success statusWidth" data-toggle="modal" disabled>Approved</button>';
			//exit();
		}
		else{
		    $aaData[$row_key][$checkVar]='<button data-target="#large_view" id="approved" class="btn-new btn-success statusWidth" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkVar1].'" onclick=javascript:enquiry_status('.$aaData[$row_key][$checkVar1].')>Approved</button>';
		}
		...
		if ($ApproveButton == 'N') {
		    ...
		    $aaData[$row_key][$checkVar]='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse statusWidth" systemId = "'.$aaData[$row_key][$checkVar1].'" onclick=javascript:enquiry_status('.$aaData[$row_key][$checkVar1].')>Amended</button>';
		}
	    
	    }if($aaData[$row_key][$checkVar]=="Rejected"){
		
		if ($ApproveButton == 'N') {
		     $aaData[$row_key][$checkVar]='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger statusWidth" disabled>Rejected</button>';
		}else{
		    $aaData[$row_key][$checkVar]='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger statusWidth" onclick=javascript:enquiry_status('.$aaData[$row_key][$checkVar1].')>Rejected</button>';
		}
...
if($tableName=='LOGI_T_SCHEDULE_HEAD' || $tableName=='LOGI_T_MEASURE_HEAD' || $tableName=='LOGI_T_JOB_REQ_HEAD')
{
  $ApproveButton = $_POST['ApproveButton'];
switch ($tableName) {
 ...
 $checkID='LSH_SYS_ID';  
        break;
    case "LOGI_T_MEASURE_HEAD":
        $checkStatus='MH_STATUS';
 $checkID='MH_SYS_ID';
 break;
    case "LOGI_T_JOB_REQ_HEAD":
  ...
  if($aaData[$row_key][$checkStatus]=="Incomplete"){
      ...
      if ($ApproveButton == 'N')
      {
   $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" disabled>Incomplete</button>';
 }
      else
      {
   $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkID].'" onclick=javascript:quotation_status('.$aaData[$row_key][$checkID].')>Incomplete</button>';
      }
 ...
 if ($ApproveButton == 'N') {
     $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" disabled>Approve ?</button>';
 }else{
     $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkID].'" onclick=javascript:quotation_status('.$aaData[$row_key][$checkID].')>Approve ?</button>';
 }
   ...
   if ($ApproveButton == 'N') {
      ...
      $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" disabled>Approved</button>';
  
   }
   else{
       $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkID].'" onclick=javascript:quotation_status('.$aaData[$row_key][$checkID].')>Approved</button>';
   }
   ...
   if ($ApproveButton == 'N') {
       ...
       $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" systemId = "'.$aaData[$row_key][$checkID].'" onclick=javascript:quotation_status('.$aaData[$row_key][$checkID].')>Amended</button>';
   }
      
      }if($aaData[$row_key][$checkStatus]=="Rejected"){
   
   if ($ApproveButton == 'N') {
        $aaData[$row_key][$checkStatus]='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" disabled>Rejected</button>';
   }else{
       $aaData[$row_key][$checkStatus]='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" onclick=javascript:quotation_status('.$aaData[$row_key][$checkID].')>Rejected</button>';
   }
...
if($tableName=='FINC_T_VOUCHER_HEAD')
{
  $ApproveButton = $_POST['ApproveButton'];
    switch ($tableName) {
	case "FINC_T_VOUCHER_HEAD":
  ...
  if($aaData[$row_key][$checkStatus]=="Incomplete"){
   ...
   $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" disabled>Incomplete</button>';
      ...
      {
   $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkID].'" onclick=javascript:voucherentry_status('.$aaData[$row_key][$checkID].')>Incomplete</button>';
      }
 ...
 if ($ApproveButton == 'N') {
     ...
     $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkID].'" onclick=javascript:voucherentry_status('.$aaData[$row_key][$checkID].')>Approve ?</button>';
 }
   ...
   if ($ApproveButton == 'N') {
      ...
      $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" disabled>Approved</button>';
       ...
       $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" systemId = "'.$aaData[$row_key][$checkID].'" onclick=javascript:voucherentry_status('.$aaData[$row_key][$checkID].')>Approved</button>';
   }
   ...
   if ($ApproveButton == 'N') {
       ...
       $aaData[$row_key][$checkStatus]='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" systemId = "'.$aaData[$row_key][$checkID].'" onclick=javascript:voucherentry_status('.$aaData[$row_key][$checkID].')>Amended</button>';
   }
   ...
   if ($ApproveButton == 'N') {
       ...
       $aaData[$row_key][$checkStatus]='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" onclick=javascript:voucherentry_status('.$aaData[$row_key][$checkID].')>Rejected</button>';
   }
...
//Purchase Request Transaction Start
	if($tableName=="PROC_T_PREQ_HEAD"){
	    $ApproveButton = $_POST['ApproveButton'];	 
	
	    if($aaData[$row_key]['PRQH_STATUS']=="Incomplete"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PRQH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" disabled>Incomplete</button>';
		}else{
		    $aaData[$row_key]['PRQH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" systemId = "'.$aaData[$row_key]['PRQH_SYS_ID'].'" onclick=javascript:Purch_request_status('.$aaData[$row_key]['PRQH_SYS_ID'].')>Incomplete</button>';
		}
	    
	    }else if($aaData[$row_key]['PRQH_STATUS']=="Send for approval"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PRQH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" disabled>Approve ?</button>';
		}else{
		    $aaData[$row_key]['PRQH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" systemId = "'.$aaData[$row_key]['PRQH_SYS_ID'].'" onclick=javascript:Purch_request_status('.$aaData[$row_key]['PRQH_SYS_ID'].')>Approve ?</button>';
		}
		
	    }else if($aaData[$row_key]['PRQH_STATUS']=="Approved"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PRQH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" disabled>Approved</button>';
		}else{
		    $aaData[$row_key]['PRQH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" systemId = "'.$aaData[$row_key]['PRQH_SYS_ID'].'" onclick=javascript:Purch_request_status('.$aaData[$row_key]['PRQH_SYS_ID'].')>Approved</button>';
		}
		
	    }else if($aaData[$row_key]['PRQH_STATUS']=="Amended"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PRQH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" disabled>Amended</button>';
		}else{
		    $aaData[$row_key]['PRQH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" systemId = "'.$aaData[$row_key]['PRQH_SYS_ID'].'" onclick=javascript:Purch_request_status('.$aaData[$row_key]['PRQH_SYS_ID'].')>Amended</button>';
		}
	    
	    }if($aaData[$row_key]['PRQH_STATUS']=="Rejected"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PRQH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" disabled>Rejected</button>';
		}else{
		    $aaData[$row_key]['PRQH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" onclick=javascript:Purch_request_status('.$aaData[$row_key]['PRQH_SYS_ID'].')>Rejected</button>';
		}
	...
	if($tableName=="PROC_T_ENQ_HEAD"){
	    $ApproveButton = $_POST['ApproveButton'];	 
	
	    if($aaData[$row_key]['EQH_STATUS']=="Incomplete"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['EQH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" disabled>Incomplete</button>';
		}else{
		    $aaData[$row_key]['EQH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" systemId = "'.$aaData[$row_key]['EQH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['EQH_SYS_ID'].')>Incomplete</button>';
		}
	    
	    }else if($aaData[$row_key]['EQH_STATUS']=="Send for approval"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['EQH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" disabled>Approve ?</button>';
		}else{
		    $aaData[$row_key]['EQH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" systemId = "'.$aaData[$row_key]['EQH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['EQH_SYS_ID'].')>Approve ?</button>';
		}
		
	    }else if($aaData[$row_key]['EQH_STATUS']=="Approved"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['EQH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" disabled>Approved</button>';
		}else{
		    $aaData[$row_key]['EQH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" systemId = "'.$aaData[$row_key]['EQH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['EQH_SYS_ID'].')>Approved</button>';
		}
		
	    }else if($aaData[$row_key]['EQH_STATUS']=="Amended"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['EQH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" disabled>Amended</button>';
		}else{
		    $aaData[$row_key]['EQH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" systemId = "'.$aaData[$row_key]['EQH_SYS_ID'].'" onclick=javascript:enquiry_status('.$aaData[$row_key]['EQH_SYS_ID'].')>Amended</button>';
		}
	    
	    }if($aaData[$row_key]['EQH_STATUS']=="Rejected"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['EQH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" disabled>Rejected</button>';
		}else{
		    $aaData[$row_key]['EQH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" onclick=javascript:enquiry_status('.$aaData[$row_key]['EQH_SYS_ID'].')>Rejected</button>';
		}
	...
	if($tableName=="PROC_T_QUOTE_HEAD"){
	    $ApproveButton = $_POST['ApproveButton'];	 
	
	    if($aaData[$row_key]['PQH_STATUS']=="Incomplete"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PQH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" disabled>Incomplete</button>';
		}else{
		    $aaData[$row_key]['PQH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" systemId = "'.$aaData[$row_key]['PQH_SYS_ID'].'" onclick=javascript:quotation_status('.$aaData[$row_key]['PQH_SYS_ID'].')>Incomplete</button>';
		}
	    
	    }else if($aaData[$row_key]['PQH_STATUS']=="Send for approval"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PQH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" disabled>Approve ?</button>';
		}else{
		    $aaData[$row_key]['PQH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" systemId = "'.$aaData[$row_key]['PQH_SYS_ID'].'" onclick=javascript:quotation_status('.$aaData[$row_key]['PQH_SYS_ID'].')>Approve ?</button>';
		}
		
	    }else if($aaData[$row_key]['PQH_STATUS']=="Approved"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PQH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" disabled>Approved</button>';
		}else{
		    $aaData[$row_key]['PQH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" systemId = "'.$aaData[$row_key]['PQH_SYS_ID'].'" onclick=javascript:quotation_status('.$aaData[$row_key]['PQH_SYS_ID'].')>Approved</button>';
		}
		
	    }else if($aaData[$row_key]['PQH_STATUS']=="Amended"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PQH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" disabled>Amended</button>';
		}else{
		    $aaData[$row_key]['PQH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" systemId = "'.$aaData[$row_key]['PQH_SYS_ID'].'" onclick=javascript:quotation_status('.$aaData[$row_key]['PQH_SYS_ID'].')>Amended</button>';
		}
	    
	    }if($aaData[$row_key]['PQH_STATUS']=="Rejected"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['PQH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" disabled>Rejected</button>';
		}else{
		    $aaData[$row_key]['PQH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" onclick=javascript:quotation_status('.$aaData[$row_key]['PQH_SYS_ID'].')>Rejected</button>';
		}
	...
	if($tableName=="PROC_T_PO_HEAD"){
	    $ApproveButton = $_POST['ApproveButton'];	 
	
	    if($aaData[$row_key]['POH_STATUS']=="Incomplete"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['POH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" disabled>Incomplete</button>';
		}else{
		    $aaData[$row_key]['POH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" systemId = "'.$aaData[$row_key]['POH_SYS_ID'].'" onclick=javascript:purchas_order_status('.$aaData[$row_key]['POH_SYS_ID'].')>Incomplete</button>';
		}
	    
	    }else if($aaData[$row_key]['POH_STATUS']=="Send for approval"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['POH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" disabled>Approve ?</button>';
		}else{
		    $aaData[$row_key]['POH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" systemId = "'.$aaData[$row_key]['POH_SYS_ID'].'" onclick=javascript:purchas_order_status('.$aaData[$row_key]['POH_SYS_ID'].')>Approve ?</button>';
		}
		
	    }else if($aaData[$row_key]['POH_STATUS']=="Approved"){
		
		if ($ApproveButton == 'N') {
		    $aaData[$row_key]['POH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" disabled>Approved</button>';
		}else{
		    $aaData[$row_key]['POH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" systemId = "'.$aaData[$row_key]['POH_SYS_ID'].'" onclick=javascript:purchas_order_status('.$aaData[$row_key]['POH_SYS_ID'].')>Approved</button>';
		}
		
	    }else if($aaData[$row_key]['POH_STATUS']=="Amended"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['POH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" disabled>Amended</button>';
		}else{
		    $aaData[$row_key]['POH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" systemId = "'.$aaData[$row_key]['POH_SYS_ID'].'" onclick=javascript:purchas_order_status('.$aaData[$row_key]['POH_SYS_ID'].')>Amended</button>';
		}
	    
	    }if($aaData[$row_key]['POH_STATUS']=="Rejected"){
		
		if ($ApproveButton == '') {
		    $aaData[$row_key]['POH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" disabled>Rejected</button>';
		}else{
		    $aaData[$row_key]['POH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" onclick=javascript:purchas_order_status('.$aaData[$row_key]['POH_SYS_ID'].')>Rejected</button>';
		}
	...
	if($tableName=="PROC_T_SA_HEAD"){
		...
		if ($ApproveButton == '') {
		    ...
		    $aaData[$row_key]['SAH_STATUS']='<button data-target="#large_view" id="created" class="btn-new btn-primary" data-toggle="modal" systemId = "'.$aaData[$row_key]['SAH_SYS_ID'].'" onclick=javascript:shipment_advice_status('.$aaData[$row_key]['SAH_SYS_ID'].')>Incomplete</button>';
		}
		...
		if ($ApproveButton == '') {
		    ...
		    $aaData[$row_key]['SAH_STATUS']='<button data-target="#large_view" id="approve" class="btn-new btn-warning" data-toggle="modal" systemId = "'.$aaData[$row_key]['SAH_SYS_ID'].'" onclick=javascript:shipment_advice_status('.$aaData[$row_key]['SAH_SYS_ID'].')>Approve ?</button>';
		}
		...
		if ($ApproveButton == '') {
		    ...
		    $aaData[$row_key]['SAH_STATUS']='<button data-target="#large_view" id="approved" class="btn-new btn-success" data-toggle="modal" systemId = "'.$aaData[$row_key]['SAH_SYS_ID'].'" onclick=javascript:shipment_advice_status('.$aaData[$row_key]['SAH_SYS_ID'].')>Approved</button>';
		}
		...
		if ($ApproveButton == '') {
		    ...
		    $aaData[$row_key]['SAH_STATUS']='<button data-target="#large_view" id="amend" data-toggle="modal" class="btn-new btn-new-inverse" systemId = "'.$aaData[$row_key]['SAH_SYS_ID'].'" onclick=javascript:shipment_advice_status('.$aaData[$row_key]['SAH_SYS_ID'].')>Amended</button>';
		}
		...
		if ($ApproveButton == '') {
		    ...
		    $aaData[$row_key]['SAH_STATUS']='<button  data-target="#large_view" id="rejected" data-toggle="modal" class="btn-new btn-danger" onclick=javascript:shipment_advice_status('.$aaData[$row_key]['SAH_SYS_ID'].')>Rejected</button>';
		}
