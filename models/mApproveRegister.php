...
//    
	...
	$select = $this->db->insert('prior_authorizaion', $data);
	$getLastInsertId=$this->db->insert_id($select);
	$sql="SELECT * FROM prior_authorizaion where prior_authorizaion_id='$getLastInsertId'";
	return $this->db->query($sql)->result_array();
    }    
    //PRIOR AUTH ENDS
